!(function (l) {
    ...
    (function (i) {
        ...
        (t.prototype.selectOptionsFromConfig = function () {
            ...
            t &&
                (i("input[type=radio][name=color-scheme-mode][value=" + t.mode + "]").prop("checked", !0),
        ...
        (t.prototype._saveConfig = function (t) {
            ...
            (t.prototype.loadConfig = function () {
                var t = JSON.parse(this.body.attr("data-layout") ? this.body.attr("data-layout") : "{}"),
                    e = n.extend({}, { mode: "light", width: "fluid", menuPosition: "fixed", sidebar: { color: "light", size: "default", showuser: !0 }, topbar: { color: "light" }, showRightSidebarOnPageLoad: !1 });
                ...
                switch (t) {
                    case "dark":
                        this.defaultBSStyle.attr("disabled", !0),
                            ...
                            e ? this._saveConfig({ mode: t }) : (this.leftSidebar.changeColor("dark"), this._saveConfig({ mode: t, sidebar: n.extend({}, this.config.sidebar, { color: "dark" }) }));
                        break;
                    default:
                        this.defaultBSStyle.attr("disabled", !1),
                            ...
                            e ? this._saveConfig({ mode: t }) : (this.leftSidebar.changeColor("light"), this._saveConfig({ mode: t, sidebar: n.extend({}, this.config.sidebar, { color: "light" }) }));
                }
        ...
        (t.prototype.initControls = function () {
            ...
            setTimeout(function () {
                ...
                e(window).on("load", function () {
                    e("#status2").fadeOut(), e("#preloader").delay(350).fadeOut("slow");
                }),
            ...
            (t.prototype.init = function () {
                ...
                window.sessionStorage &&
                    ...
                    (sessionStorage.getItem("_UBOLD_VISITED_") || (e.RightBar.toggleRightSideBar(), sessionStorage.setItem("_UBOLD_VISITED_", !0)));
            }),
            (e.App = new t()),
            (e.App.Constructor = t);
    })(window.jQuery),
