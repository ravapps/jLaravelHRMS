...
<div class="row mt-4">
    <div class="col-12">
        <div class="page-title-box-hori">
            <h4 class="page-title">{{__('Employee Profile')}}</h4>
                                ...
                                <div class="staff staff-grid-view pb-0">
                                    ...
                                    @can('Show Employee Profile')
                                        <div class="meta-info mb-3">
                                            <a href="{{route('show.employee.profile',\Illuminate\Support\Facades\Crypt::encrypt($employee->id))}}" class="btn  btn-success">{{ \Auth::user()->employeeIdFormat($employee->employee_id) }}</a>
                                        </div>
                                    @else
                                        <div class="meta-info mb-3">
