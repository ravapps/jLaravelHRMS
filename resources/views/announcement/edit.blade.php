...
<div class="card-body p-0">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                {{Form::label('start_date',__('Announcement Date'))}}
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <select name="status" required class="form-control">
                  ...
                  <option value="Pending" @if($announcement->status=='Pending') selected='selected' @endif)>Pending</option>
                  <option value="Approved" @if($announcement->status=='Approved') selected='selected' @endif>Approved</option>
                </select>
