                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-2 coupon-apply-btn">
                                                            <div class="form-group apply-stripe-btn-coupon">
                                                                <a href="#" class="btn btn-success coupon-apply-btn apply-coupon">{{ __('Apply') }}</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-2 coupon-apply-btn">
                                                            <div class="form-group apply-paypal-btn-coupon">
                                                                <a href="#" class="btn btn-success apply-coupon">{{ __('Apply') }}</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
