                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                ...
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail h-150">
                                                        <img src="{{$logo.'/'.(isset($company_logo) && !empty($company_logo)?$company_logo:'logo.png')}}" alt="" height="100">
                                                    </div>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail h-100">
                                                        <img src="{{$logo.'/'.(isset($company_small_logo) && !empty($company_small_logo)?$company_small_logo:'small_logo.png')}}" alt=""  height="100">
                                                    </div>
                                                    <div class="fileinput-preview fileinput-exists thumbnail thumbnail-h3"></div>
                                                    <div>
                                                <span class="btn btn-success btn-file">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail h-100">
                                                        <img src="{{$logo.'/'.(isset($company_favicon) && !empty($company_favicon)?$company_favicon:'favicon.png')}}" alt=""  height="100">
                                                    </div>
                                                    <div class="fileinput-preview fileinput-exists thumbnail thumbnail-h3"></div>
                                                    <div>
                                                <span class="btn btn-success btn-file">
                                                    ...
                                                    <div class="col-sm-6 col-md-12">
                                                        <div class="d-flex w-100">
                                                            ...
                                                            <label class="custom-control custom-radio">
                                                                <input type="radio" name="site_currency_symbol_position" value="pre" class="custom-control-input" @if($settings['site_currency_symbol_position'] == 'pre') checked @endif>
                                                                <span class="custom-control-label">{{__('Pre')}}</span>
                                                            </label>
                                                            <label class="custom-control custom-radio ml-1">
                                                                <input type="radio" name="site_currency_symbol_position" value="post" class="custom-control-input" @if($settings['site_currency_symbol_position'] == 'post') checked @endif>
                                                                <span class="custom-control-label">{{__('Post')}}</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <tr class="font-style odd" role="row">
                                                        ...
                                                        <td class="action">
                                                          <div class="custom-control custom-switch">
                                                              <input type="checkbox" class="custom-control-input email-template-checkbox" name="{{$key}}" {{\App\Utility::getValByName("$key") ==1 ?'checked':''}} value="{{\App\Utility::getValByName("$key") ==1 ?'1':'0'}}" data-url="{{route('company.email.setting',$key)}}">
