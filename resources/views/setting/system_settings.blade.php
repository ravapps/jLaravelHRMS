                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                ...
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail h-150">
                                                        <img src="{{$logo.'/logo.png'}}" alt="" height="100">
                                                    </div>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail h-150">
                                                        <img src="{{$logo.'/small_logo.png'}}" alt="" height="100">
                                                    </div>
                                                    <div class="fileinput-preview fileinput-exists thumbnail thumbnail-h3"></div>
                                                    <div>
                                                        <span class="btn btn-success btn-file">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail h-150">
                                                        <img src="{{$logo.'/favicon.png'}}" alt=""  height="100">
                                                    </div>
                                                    <div class="fileinput-preview fileinput-exists thumbnail thumbnail-h3"></div>
                                                    <div>
                                                        <span class="btn btn-success btn-file">
                                        ...
                                        <div class="payment-setting-wrap">
                                            ...
                                            <div class="row card-body pb-0">
                                                <div class="form-group col-md-12">
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" name="enable_stripe" class="custom-control-input" {{ env('ENABLE_STRIPE') == 'on' ? 'checked="checked"' : '' }}>
                                                        <label class="custom-control-label" for="customSwitch1">{{Form::label('is_enable_stripe',__('Enable Stripe'), ['class' => 'custom-toggle-btn']) }}</label>
                                                    </div>
                                            ...
                                            <div class="row card-body pb-0">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" name="enable_paypal" class="custom-control-input" {{ env('ENABLE_PAYPAL') == 'on' ? 'checked="checked"' : '' }}>
                                                        <label class="custom-control-label" for="customSwitch1">{{Form::label('enable_stripe',__('Enable Paypal'), ['class' => 'custom-toggle-btn']) }}</label>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="d-flex w-100">
                                                        <div class="custom-control custom-radio mr-1">
                                                            <input type="radio" name="paypal_mode" value="sandbox" class="custom-control-input" {{ env('PAYPAL_MODE') == '' || env('PAYPAL_MODE') == 'sandbox' ? 'checked="checked"' : '' }}>
                                                            <span class="custom-control-label">{{ __('Sandbox') }}</span>
                                                        </div>
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" name="paypal_mode" value="live" class="custom-control-input" {{ env('PAYPAL_MODE') == 'live' ? 'checked="checked"' : '' }}>
                                                            <span class="custom-control-label">{{ __('Live') }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6">
