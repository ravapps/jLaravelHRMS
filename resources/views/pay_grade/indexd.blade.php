...
<div class="row mt-4">
    <div class="col-12">
        <div class="page-title-box-hori">
            <h4 class="page-title">{{__('Manage Daily Pay Grade')}}</h4>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between w-100">
                    ...
                    @can('Manage Monthly Grade')
                        <a href="{{ route('daily_grade.create') }}" class="btn btn-icon icon-left btn-success">
            ...
            <div class="card-body">
              <form action="{{route('daily_grade.index')}}" methode="get">
                  <div class="row">
                      <div class="col">
                      ...
                      <div class="col-auto">
                          <div class="form-group">
                           <label class="w-100">&nbsp;</label>
                            ...
                            <a href="{{route('daily_grade.index')}}" class="btn btn-danger">{{__('Reset')}}</a>
                          </div>
                      </div>
                  </div>
              </form>
                        ...
                        @foreach ($monthly_grades as $monthly_grade)
                            <tr>
                                ...
                                <td class="text-right">
                                        ...
                                        @can('Manage Monthly Grade')
                                            <a href="{{ URL::to('daily_grade/'.$monthly_grade->id.'/edit') }}"  class="btn btn-outline-success  mr-1" data-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="fas fa-pencil-alt"></i> <span>{{__('Edit')}}</span></a>
                                        @endcan
                                    ...
                                    @can('Manage Monthly Grade')
                                        ...
                                        {!! Form::open(['method' => 'DELETE', 'route' => ['daily_grade.destroy', $monthly_grade->id],'id'=>'delete-form-'.$monthly_grade->id]) !!}
                                        {!! Form::close() !!}
                                    @endif
                                </td>
                            </tr>
