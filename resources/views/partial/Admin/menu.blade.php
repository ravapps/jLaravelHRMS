        ...
        <ul class="sidebar-menu">
            ...
            @if(Gate::check('Manage Increment'))
                @can('Manage Increment')
                    <li class="{{ (Request::route()->getName() == 'increment.index') ||  (Request::route()->getName() == 'increment.create') ||  (Request::route()->getName() == 'increment.edit') ? 'active' : '' }}">
                        <a class="nav-link" href="{{route('increment.index')}}"><i class="fas fa-users"></i> <span>{{ __('Increments') }}</span></a>
                    </li>
                    @endcan
            @endif
            @if(Gate::check('Manage Promotion'))
                @can('Manage Promotion')
                                <li class="{{ request()->is('promotion*') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('promotion.index') }}"><i class="fas fa-users"></i> <span> {{ __('Promotion') }}</span></a>
                                </li>
                            @endcan
             @endif
            @if(Gate::check('Manage Set Salary') || Gate::check('Manage Pay Slip') || Gate::check('Manage Monthly Grade') || Gate::check('Manage Allowance Option') || Gate::check('Commission') || Gate::check('Manage Bonus') || Gate::check('Manage Bonus Commission Type'))
                <li class="{{ (Request::route()->getName() == 'bonus.index' || Request::route()->getName() == 'bonuscommission.index' || Request::route()->getName() == 'setsalary.index' || Request::route()->getName() == 'setsalary.show' || Request::route()->getName() == 'commission.index' || Request::route()->getName() == 'monthly_grade.index' || Request::route()->getName() == 'allowanceoption.index'  ||  Request::route()->getName() == 'payslip.index' || Request::route()->getName() == 'payslip.employeepayslip' || Request::route()->getName() == 'setsalary.edit' || Request::route()->getName() == 'employeesalary' || Request::route()->getName() == 'payslip.employeepayslip' || Request::route()->getName() == 'payslip.pdf') ? 'active' : '' }}">
                    ...
                    @can('Manage Bonus Commission Type')
                            <li class="{{ request()->is('bonuscommission*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('bonuscommission.index') }}">{{ __('Bonus Comminsion Type') }}</a>
                            </li>
                        @endcan

                    @can('Manage Allowance Option')
                            <li class="{{ request()->is('allowanceoption*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('allowanceoption.index') }}">{{ __('Allowance') }}</a>
                            </li>
                        @endcan

                        @can('Commission')
                            <li class="{{ request()->is('commission*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('commission.index') }}">{{ __('Commission') }}</a>
                            </li>
                        @endcan
                        @can('Claim')
                            <li class="{{ request()->is('claim*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('claim.index') }}">{{ __('Claim') }}</a>
                            </li>
                        @endcan
                        @can('Shift Type')
                            <li class="{{ request()->is('shift_type*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('shift_type.index') }}">{{ __('Shift Managment') }}</a>
                            </li>
                        @endcan
                        @can('Roaster')
                            <li class="{{ request()->is('roaster*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('roaster.index') }}">{{ __('Shift Roster') }}</a>
                            </li>
                        @endcan
                        @can('Manage Bonus')
                            <li class="{{ request()->is('bonus') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('bonus.index') }}">{{ __('Bonus') }}</a>
                            </li>
                        @endcan

                     @can('Manage Monthly Grade')
                            <li class="{{ request()->is('monthly_grade*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('monthly_grade.index') }}">{{ __('Monthly Pay Grade') }}</a>
                            </li>
                        @endcan
                     
                        @can('Manage Monthly Grade')
                            <li class="{{ request()->is('daily_grade*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('daily_grade.index') }}">{{ __('Daily Pay Grade') }}</a>
                            </li>
                        @endcan
                        @can('Manage Monthly Grade')
                            <li class="{{ request()->is('hourly_grade*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('hourly_grade.index') }}">{{ __('Hourly Pay Grade') }}</a>
                            </li>
                        @endcan
            ...
            @if( Gate::check('Manage Attendance') || Gate::check('Manage Leave') || Gate::check('Manage TimeSheet') || Gate::check('Manage Holiday'))
                <li class="dropdown {{ (Request::route()->getName() == 'attendanceemployee.index' || Request::route()->getName() == 'leave.index'  || Request::route()->getName() == 'timesheet.index' || Request::route()->getName() == 'attendanceemployee.bulkattendance') ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>{{ __('Leave') }}</span></a>
                    <ul class="dropdown-menu">
                        ...
                        @can('Manage Leave')
                            ...
                            <li class="{{ request()->is('balance_leave*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ url('balance_leave') }}">{{ __('Manage Leave Balance') }}</a>
                            </li>

                            <li class="{{ request()->is('leave_sumary*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ url('leave_sumary') }}">{{ __('Leave Summary Report') }}</a>
                            </li>
                        @endcan
                        @can('Manage Holiday')
                            <li class="{{ request()->is('holiday*') ? 'active' : '' }}">
                                <a class="nav-link " href="{{ route('holiday.index') }}">{{ __('Preset Public Holidays') }}</a>
                            </li>
                        @endcan

                       
                        @can('Manage Attendance')
                            <li class="dropdown {{ (Request::route()->getName() == 'attendanceemployee.index' || Request::route()->getName() == 'attendanceemployee.bulkattendance') ? 'active' : '' }}">
                                <a class="nav-link has-dropdown" data-toggle="dropdown" href="#">{{ __('Attendance') }}</a>
                                <ul class="dropdown-menu">
                                    ...
                                    @can('Create Attendance')
                                        <li class="{{ (Request::route()->getName() == 'attendanceemployee.bulkattendance') ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ route('attendanceemployee.bulkattendance') }}">{{ __('Bulk Attendance') }}</a>
                                        </li>
                                    @endcan
                                </ul>
                            </li>
            ...
            @if(Gate::check('Manage Awards') || Gate::check('Manage Transfer') || Gate::check('Manage Resignation')  || Gate::check('Manage Travels') ||  Gate::check('Manage Complaint')|| Gate::check('Manage Warning') || Gate::check('Manage Termination') || Gate::check('Manage Announcement'))
                <li class="dropdown {{ (Request::route()->getName() == 'award.index' ||  Request::route()->getName() == 'transfer.index' || Request::route()->getName() == 'resignation.index' || Request::route()->getName() == 'travel.index' ||   Request::route()->getName() == 'complaint.index' || Request::route()->getName() == 'warning.index' || Request::route()->getName() == 'termination.index'
            ...
            @if(Auth::user()->type != 'super admin')
                <li class="{{ (Request::route()->getName() == 'messages') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ url('messages') }}"><i class="fas fa-comments"></i> <span>{{__('Messenger')}}</span></a>
                </li>
            @endif
            ...
            @if(Gate::check('Manage Report'))
                <li class="dropdown {{ (Request::route()->getName() == 'report.income-expense' || Request::route()->getName() == 'report.leave' || Request::route()->getName() == 'report.account.statement' || Request::route()->getName() == 'report.payroll' || Request::route()->getName() == 'report.monthly.attendance' || Request::route()->getName() == 'report.timesheet' ) ? 'active' : '' }}">
